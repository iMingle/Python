...
# 数据加载，避免中文乱码问题
data_ori = pd.read_csv('./data/em_hero.csv')
...
data_ori.to_csv('./data/em_hero_out.csv', index=False, sep=',')

# 聚类结果评估,采用 Calinski-Harabaz 指标
# 指标分数越高，代表聚类效果越好，也就是相同类中的差异性小，不同类之间的差异性大
print(metrics.calinski_harabaz_score(data, prediction))
